...
// let arrs = [12,23,300,41,550,79,780,22,660]
// const rotateArr = (arr, rotateOrder)=>{
//    let n = arr.length;
//     rotateOrder %= n;
//     return arr.slice(rotateOrder).concat(arr.slice(0,rotateOrder))    
// }

// let newArr = rotateArr(arrs,2);
// console.log(newArr);

// 	26.	Use .find() to locate the first even number in an array.
// let arr = [1,3,4,5,6,7,8]
// const found = arr.find(e => e % 2 === 0);
// console.log(found);
